        ...
        return (
            <div className="extracurricularWrapperDiv">
                <div style={{ position: "relative", top:"5%", left: "1%"}}>
                    ...
                    {map(extracurricular,(activity,index) =><Paper square elevation={0} key={index} style={{position: "relative", padding: "8px" ,marginTop: 16, marginBottom: 16, marginLeft: 4, marginRight: 2, width: "98%", left: "0%", border:"4px white solid", background: "black"}}>
